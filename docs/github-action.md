...
jobs:
  review:
    ...
    steps:
      ...
      - uses: husnuguner/code-reviewer/actions/review@v0.0.6
        with:
  ...
  comment: # the only job that can write, and it runs no model
    ...
    steps:
      ...
      - uses: husnuguner/code-reviewer/actions/comment@v0.0.6 # same version as the review job
...
```yaml
- uses: husnuguner/code-reviewer/actions/review@v0.0.6 # this exact release; recommended while 0.x
