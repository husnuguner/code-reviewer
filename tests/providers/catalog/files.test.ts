/**
 * The catalogue use-cases through the real file store: `init`, `projects`
 * and `add` print what the fixtures froze, write what they promise, and
...
import { addProject } from "../../../src/core/catalog/add-project";
import { type Catalog } from "../../../src/core/catalog/catalog";
import { initCatalog } from "../../../src/core/catalog/init";
import { listProjects } from "../../../src/core/catalog/list-projects";
import { parseCatalog } from "../../../src/core/catalog/parse";
import { PROJECT_SETTING_KEYS } from "../../../src/core/catalog/schema";
import { type CatalogFiles } from "../../../src/core/ports/catalog-files";
import { type ConsoleOutput } from "../../../src/core/ports/console";
import { shippedFile } from "../../../src/providers/assets/shipped-files";
import { FsCatalogFiles } from "../../../src/providers/catalog/files";
...
describe("the catalogue commands", () => {
  ...
  it("ships a repo-local starter that parses, names one project, and reads skills from beside itself", () => {
    ...
    // And it says nothing at all about the standing instructions: every *.md
    // under .review/prompts/ is read because it is there, so filling in the
    // empty file `init` writes is all a repository has to do to be heard.
    expect(Object.keys(project.settings)).not.toContain("prompts");
